...
int main()
{
	...
	if (shippedEffects.size() != 7 ||
		...
		gravityInsideDefinition != &EffectData::GravityAnomalyInsideEffect ||
	...
	sas::GameplayAttributeList timingAttributes = AbilityData::AbilityActors::Actor_SunBeam_Basic.attributes;
