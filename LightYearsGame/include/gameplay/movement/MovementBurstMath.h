...
namespace ly::movement::MovementBurstMath
{
	inline constexpr float RatingDiminishingScale = 20.f;
	inline constexpr float MaximumDistanceBonus = 0.50f;

	// The generic movement curve is kept outside any ability family so a future
	// movement action can reuse the same bounded rating-to-distance behavior.
