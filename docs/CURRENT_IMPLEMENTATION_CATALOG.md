...
| Başlangıç loadout | ✅ BasicRapidLaser + Shield + SunBeam | LightYearsGame/include/gameConfigs/ship/ShipConfig.h; LightYearsGame/src/player/PlayerSpaceShip.cpp | Alternatif silah/ability seçimi henüz burada varsayılan değil |
...
| --- | --- | --- | --- | --- | --- | --- |
| FighterBasicRapidLaser | ✅ | Evet | Standard / Photonic | 8 damage, 8 fire rate, 1100 speed, 1600 range, 1 muzzle | Damage +1.0 AttackPower; FireRate +1.0 AttackSpeed | Runtime L1/10/25/50 single-target DPS verified |
| PlayerRapidShotgun | ⚙️ | Hayır | Shotgun / Thermal | 10 damage, 2.5 fire rate, 3 pellet, 8° spread, 400 range | Damage +0.75 AP; FireRate +0.5 AS | Runtime AP/AS, three-pellet same-target aggregate and Ignite profile verified |
| PlayerDualKineticBlaster | ⚙️ | Hayır | Standard / Kinetic | 3.5 damage, 12 fire rate, 2 muzzle, 3400 speed, 650 range | Damage +0.45 AP; FireRate +1.0 AS | Runtime two-muzzle DPS verified; L50 remains below Rapid Laser |
| PlayerElectricArcLauncher | ⚙️ | Hayır | Arc / Electric | 15 damage, 2.8 fire rate, 850 first range, 3 extra chain, 250 chain range, x0.72 | Damage +0.85 AP; FireRate +0.60 AS; Luck has no direct damage scaling | Runtime 1/2/4/5 target, falloff, no-duplicate and capped bonus-chain chance verified |
| PlayerContinuousHeatLaser | ⚙️ | Hayır | Continuous Beam / Energy | 28 DPS, 950 range, 26 width, 38 heat/sn, cap 100, cool 25/sn | Damage +0.75 AP +0.50 EnergyMax; AttackSpeed only reduces high-heat gain | Runtime AP/Energy, heat zones, overheat and 10/30s sustained DPS verified |
| PlayerCryoWaveProjector | ⚙️ | Hayır | Expanding Wave / Cryo | 7 damage, 1.8 fire rate, 780 range, 850 speed, width 80→260 | Damage +0.75 AP; FireRate +0.5 AS | Runtime L1/10/25/50 damage/rate and four-hit slow tempo verified |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Ship_Player_Fighter | ✅ | 100 | 25 | 0 / 0 | FighterBasicRapidLaser | Yok | [ ] Varsayılan baseline |
