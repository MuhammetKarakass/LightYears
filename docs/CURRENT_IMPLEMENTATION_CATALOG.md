...
> Varsayılan loadout: Q Ember Swarm, E Relay Prism, F Glacial Pressure, R
> Ironclad Protocol. Vault için kısa eşlenik: `docs/vault/00 - Runtime Snapshot.md`.
...
| Başlangıç loadout | ✅ BasicRapidLaser + EmberSwarm + RelayPrism + GlacialPressure + IroncladProtocol | `gameplay/ability/loadout/DefaultAbilityLoadout.cpp`; `player/PlayerSpaceShip.cpp` | Runtime binding tanımdaki content slotundan ayrıdır; shipped catalog'daki diğer ability'ler sonradan uygun slota takılabilir |
